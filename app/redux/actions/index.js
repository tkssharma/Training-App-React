...
export function authUpdateRegisterFormField( data ) {
	return {
		type: AUTH_UPDATE_REGISTER_FORM_FIELD,
		payload: data
	}
}
export function authSubmitRegisterForm( data ) {
	return {
		type: AUTH_SUBMIT_REGISTER_FORM,
		payload: data
	}
}
export function authInvalidateRegisterForm( data ) {
	return {
		type: AUTH_INVALIDATE_REGISTER_FORM,
		payload: data
	}
}
export function authResetRegisterFormFields() {
	return {
		type: AUTH_RESET_REGISTER_FORM_FIELDS
	}
}
...
export function authServerRegisterUser( data ) {
	return dispatch => {
		...
		return axios.post( API.url('register'), data )
				.then( (response) => {
...
export function authUpdateLoginFormField( data ) {
	return {
		type: AUTH_UPDATE_LOGIN_FORM_FIELD,
		payload: data
	}
}
...
export function authInvalidateLoginForm( data ) {
	return {
		type: AUTH_INVALIDATE_LOGIN_FORM,
		payload: data
	}
}
...
export function authResetLoginFormFields() {
	return {
		type: AUTH_RESET_LOGIN_FORM_FIELDS
	}
}
...
export function authUpdateUserData( data ) {
	if ( ! data.hasPassword ) {
		data.hasPassword = StorageAPI.user.getHasPassword();
	}
	// console.log('data', data);
	// console.log('user_userType', localStorage.user_userType );
	if ( data.userType == 1 && data.userType != StorageAPI.user.getUserType() ) {
		data.userType = StorageAPI.user.getUserType();
	}
	return {
	...
	return dispatch => {
		...
		return axios.post( API.url('login'), data )
			...
			.catch( (error) => {
				...
				notification.warning({
					message: 'Error Occoured',
					description: "Error occoured while connecting to server, Please try again after some time.",
				});
			});
	}
}
...
export function authSubmitResetPasswordForm(status) {
	return {
		type: AUTH_SUBMIT_RESET_PASSWORD_FORM,
		payload: status
	}
}
export function authUpdateResetPasswordStatusField(data) {
	return {
		type: AUTH_UPDATE_RESET_PASSWORD_STATUS_FIELD,
		payload: data
	}
}
...
export function authInvalidateResetPasswordForm( data ) {
	return {
		type: AUTH_INVALIDATE_RESET_PASSWORD_FORM,
		payload: data
	}
}
...
export function authServerResetPassword( data ) {
	return dispatch => {
		...
		return axios.post( API.url('reset_password'), data )
			.then( (response) => {
				let json = response.data;
...
export function userUpdateProfileField(data) {
	return {
		type: USER_UPDATE_PROFILE_FIELD,
		payload: data
	}
}
...
export function userDeleteProfileField(data) {
	return {
		type: USER_DELETE_PROFILE_FIELD,
		payload: data
	}
}
...
export function uiProcessingUpdateField( data ) {
	return {
		type: UI_PROCESSING_UPDATE_FIELD,
		payload: data
	}
}
...
export function hostCreateEventMany( data ) {
	data.map( (event) => {
		if ( event.type ) { event.type = event.type.toString(); }
		if ( event.duration ) { event.duration = event.duration.toString(); }
		if ( event.venue_type ) { event.venue_type = event.venue_type.toString(); }
	});
	return {
		type: TRAINER_CREATE_TRAINING_MANY,
		payload: data
	}
}
...
export function hostCreateEvent( data ) {
	...
	if ( data.duration ) { data.duration = data.duration.toString(); }
	if ( data.venue_type ) { data.venue_type = data.venue_type.toString(); }
	return {
		type: TRAINER_CREATE_TRAINING,
		payload: data
	}
}
export function hostUpdateEvent( data ) {
	return {
		type: TRAINER_UPDATE_TRAINING,
		payload: data
	}
}
export function hostDeleteEventField( data ) {
	return {
		type: TRAINER_DELETE_TRAINING_FIELD,
		payload: data
	}
}
...
export function hostUpdateEventSection( data ) {
	return {
		type: TRAINER_UPDATE_TRAINING_SECTION,
		payload: data
	}
}
...
export function hostUpdateEventAction( data ) {
	return {
		type: TRAINER_UPDATE_TRAINING_ACTION,
		payload: data
	}
}
...
export function hostCreateAllakarteMany( data ) {
	data.map( (record) => {
		if ( record.booking_type ) { record.booking_type = record.booking_type.toString(); }
	});
	return {
		type: TRAINER_CREATE_WEBINAR_MANY,
		payload: data
	}
}

export function hostCreateAllakarte( data ) {
	if ( data.booking_type ) { data.booking_type = data.booking_type.toString(); }
	return {
		type: TRAINER_CREATE_WEBINAR,
		payload: data
	}
}
export function hostUpdateAllakarte( data ) {
	return {
		type: TRAINER_UPDATE_WEBINAR,
		payload: data
	}
}
...
export function wwwLoadEvent( data ) {
	return {
		type: WWW_LOAD_TRAINING,
		payload: data
	}
}
export function wwwLoadEvents( data ) {
	return {
		type: WWW_LOAD_TRAININGS,
		payload: data
	}
}
...
export function wwwUpdateCurrentBookingField( data ) {
	return {
		type: WWW_UPDATE_CURRENT_REGISTRATION_FIELD,
		payload: data
	}
}
...
export function wwwResetCurrentBookingFields( data ) {
	return {
		type: WWW_RESET_CURRENT_REGISTRATION_FIELDS,
		payload: data
	}
}
...
export function userCreateBookingMany( data ) {
	return {
		type: USER_CREATE_REGISTRATION_MANY,
		payload: data
	}
}
